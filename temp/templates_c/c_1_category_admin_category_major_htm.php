			 ...
			 {	
				...
				{	
				 ...
				 var html="";
					...
					html+="<a onclick=\"return confirm('你确定要删除吗？')\" href=\"?act=del_major_category&id="+val[0]+"&<?php echo $this->_vars['urltoken']; ?>
\">删除</a>";
					html+="</td>";	
					html+="</tr>";
					i++;
...
" class="input_text_50"/>
      ...
      <td class="admin_list">
	  <a href="?act=add_category_major&parentid=<?php echo $this->_vars['list']['id']; ?>
">此类下加子类</a>
			 </td>
    </tr>
