...
" <?php if ($_GET['is_display'] == "0"): ?>class="select"<?php endif; ?>>停止</a>
	...
	<div class="list listod" style=" width:200px;">
	  ...
	  <div class="txt link_lan">
	  <a href="<?php echo $this->_run_modifier("subsite_id:,category_id:", 'qishi_parse_url', 'plugin', 1); ?>
" <?php if ($_GET['subsite_id'] == ""): ?>class="select"<?php endif; ?>>不限</a>
 <?php if (count((array)$this->_vars['subsite'])): foreach ((array)$this->_vars['subsite'] as $this->_vars['cli']): ?>
 <a href="<?php echo $this->_run_modifier($this->_run_modifier($this->_run_modifier("subsite_id:", 'cat', 'plugin', 1, $this->_vars['cli']['s_id']), 'cat', 'plugin', 1, ",category_id:"), 'qishi_parse_url', 'plugin', 1); ?>
" <?php if ($_GET['subsite_id'] == $this->_vars['cli']['s_id']): ?>class="select"<?php endif; ?>><?php echo $this->_vars['cli']['s_sitename']; ?>
</a>
