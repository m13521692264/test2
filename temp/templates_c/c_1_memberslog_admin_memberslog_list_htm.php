...
<span style="color: #CCCCCC">[uid:<?php echo $this->_vars['li']['log_uid']; ?>
        ...
        <td   class="admin_list"  align="center"><?php if ($this->_vars['li']['log_ip']):  echo $this->_vars['li']['log_ip'];  else: ?>&nbsp;<?php endif; ?></td>
        <td   class="admin_list"  align="center"><?php if ($this->_vars['li']['log_address']):  echo $this->_vars['li']['log_address'];  else: ?>&nbsp;<?php endif; ?></td>
