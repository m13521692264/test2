...
$(document).ready(function()
{
	...
	$(".leftimg2").live('click',function()
	{
		$(".Sclass2_"+$(this).attr("id")).toggle();
		SetCat2($(this).attr("id"),$(this).attr("parentid"));
		if ($(".Sclass2_"+$(this).attr("id")).css("display")=="none")
		{
			$(this).attr("src","images/left_e.gif");
		}
		else
	...
	$("#ButDel").click(function(){
		...
		{
			$("form[name=form1]").attr("action","?act=del_qgdistrict_category");
	...
	function SetCat2(pid,parentid)
	{
		if ($(".Sclass2_"+pid).length == 0)
		{
			MakeCat2(pid,parentid);
		}
	}

	function MakeCat2(pid,parentid)
	{
		var tsTimeStamp= new Date().getTime();
		$.get("admin_ajax.php", {"act":"get_cat_qgdistrict","tstime":tsTimeStamp,"pid":pid},
				function (data,textStatus)
				{
					if (data)
					{
						...
						{
							var val=str[x].split(",");
							html+="<tr class=\"Sclass2_"+pid+" Sclasst2_"+parentid+"\">";
							html+="<td  class=\"admin_list\"  style=\"padding-left:53px;\">";
							html+="<img src=\"images/cat_left1.gif\" border=\"0\" align=\"absmiddle\" />";
							html+="<img src=\"images/cat_left1.gif\" border=\"0\" align=\"absmiddle\" />";
							html+="<img src=\"images/cat_left1.gif\" border=\"0\" align=\"absmiddle\" />";
//							html+='<img src="images/left_e.gif" border="0" align="absmiddle" parentid="'+pid+'"  id="'+val[0]+'" class="leftimg2 pointer"/>';
							...
							html+="</td>";
							html+="<td class=\"admin_list\"  style=\"padding-left:86px; color:#FF6600\">";
//							html+="<a href=\"?act=add_category_qgdistrict&parentid="+val[0]+"\">此类下加子类</a>&nbsp;&nbsp;&nbsp;&nbsp;";

							html+="<a href=\"?act=edit_qgdistrict_category&id="+val[0]+"\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;";
							html+="<a onclick=\"return confirm('你确定要删除吗？')\" href=\"?act=del_qgdistrict_category&id="+val[0]+"&<?php echo $this->_vars['urltoken']; ?>
\">删除</a>";
							html+="</td>";
							html+="</tr>";
							i++;
						}
						$("#Sclass1_"+pid).after(html);
						//如果大类已经选择，则小类也勾选
			 ...
			 {	
				...
				{	
				 ...
				 var html="";
					...
					{
					var val=str[x].split(",");
					html+="<tr class=\"Sclass1_"+pid+"\" id=\"Sclass1_"+val[0]+"\">";
			  		html+="<td  class=\"admin_list\"  style=\"padding-left:53px;\">";
			  		html+="<img src=\"images/cat_left1.gif\" border=\"0\" align=\"absmiddle\" />";
			  		html+="<img src=\"images/cat_left1.gif\" border=\"0\" align=\"absmiddle\" />";
					html+='<img src="images/left_e.gif" border="0" align="absmiddle" parentid="'+pid+'"  id="'+val[0]+'" class="leftimg2 pointer"/>';
...
删除顶级级分类将会自动删除此分类下的子分类。<br />
  ...
  <form id="form1" name="form1" method="post" action="?act=qgdistrict_all_save">
...
" class="input_text_50"/>
    ...
    <td class="admin_list">
		<a href="?act=add_category_qgdistrict&parentid=<?php echo $this->_vars['list']['id']; ?>
">此类下加子类</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="?act=edit_qgdistrict_category&id=<?php echo $this->_vars['list']['id']; ?>
">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;

		<a onclick="return confirm('你确定要删除吗？')" href="?act=del_qgdistrict_category&id=<?php echo $this->_vars['list']['id']; ?>
...
<tr>
        ...
        <input name="ButADD" type="button" class="admin_submit" id="ButADD" value="添加分类"  onclick="window.location='?act=add_category_qgdistrict'"/>
