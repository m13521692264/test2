...
<table width="100%" border="0" cellspacing="6" cellpadding="0" style="border-bottom:1px #93AEDD  dashed">
 <tr>
	...
	<select name="parentid[]">
	  ...
	  <?php echo tpl_function_qishi_get_classify(array('set' => "列表名:qgdistrict,类型:QS_qgdistrict,id:0"), $this); if (count((array)$this->_vars['qgdistrict'])): foreach ((array)$this->_vars['qgdistrict'] as $this->_vars['list']): ?>
...
" <?php if ($this->_vars['list']['id'] == $_GET['parentid']): ?>selected="selected"<?php endif; ?>><?php echo $this->_vars['list']['categoryname']; ?>
	  ...
	  <?php echo tpl_function_qishi_get_classify(array('set' => "列表名:sub_qgdistrict,类型:QS_qgdistrict,id:" . $this->_vars['list']['id'] . ""), $this); if (count((array)$this->_vars['sub_qgdistrict'])): foreach ((array)$this->_vars['sub_qgdistrict'] as $this->_vars['s_list']): ?>
...
" <?php if ($this->_vars['s_list']['id'] == $_GET['parentid']): ?>selected="selected"<?php endif; ?>>├─<?php echo $this->_vars['s_list']['categoryname']; ?>
        ...
        <?php echo tpl_function_qishi_get_classify(array('set' => "列表名:ssub_qgdistrict,类型:QS_qgdistrict,id:" . $this->_vars['s_list']['id'] . ""), $this); if (count((array)$this->_vars['ssub_qgdistrict'])): foreach ((array)$this->_vars['ssub_qgdistrict'] as $this->_vars['ss_list']): ?>
