...
" <?php if ($_GET['audit'] == "3"): ?>class="select"<?php endif; ?>>审核未通过<span>(<?php echo $this->_vars['total']['4']; ?>
	  ...
	  <div class="txt link_lan">
	 	<a href="<?php echo $this->_run_modifier("invalid:", 'qishi_parse_url', 'plugin', 1); ?>
" <?php if ($_GET['invalid'] == ""): ?>class="select"<?php endif; ?>>不限</a>
		<a href="<?php echo $this->_run_modifier("invalid:1", 'qishi_parse_url', 'plugin', 1); ?>
" <?php if ($_GET['invalid'] == "1"): ?>class="select"<?php endif; ?>>职位到期</a>
		<a href="<?php echo $this->_run_modifier("invalid:2", 'qishi_parse_url', 'plugin', 1); ?>
" <?php if ($_GET['invalid'] == "2"): ?>class="select"<?php endif; ?>>套餐到期</a>
		<a href="<?php echo $this->_run_modifier("invalid:3", 'qishi_parse_url', 'plugin', 1); ?>
" <?php if ($_GET['invalid'] == "3"): ?>class="select"<?php endif; ?>>职位暂停</a>
		<a href="<?php echo $this->_run_modifier("invalid:4", 'qishi_parse_url', 'plugin', 1); ?>
" <?php if ($_GET['invalid'] == "4"): ?>class="select"<?php endif; ?>>非审核通过</a>
	  </div>
    	</div>
	  <?php endif; ?>
