...
"><?php echo $this->_vars['list']['categoryname']; ?>
		  ...
		  <tr class="jobmain">
			...
			<td id="jobsSort" style="position:relative;">
             <div id="jobText" class="input_text_200_bg choose_cate ucc-default"><?php echo $this->_run_modifier($this->_vars['jobs']['category_name'], 'default', 'plugin', 1, "请选择"); ?>
</div>	
				<!-- 职位类别弹出框 -->
...
" />
			  <div class="input_radio <?php if ($this->_vars['jobs']['sex'] == '100'): ?>select<?php endif; ?>" id="3">不限</div>
			  <div class="input_radio <?php if ($this->_vars['jobs']['sex'] == '200'): ?>select<?php endif; ?>" id="1">男</div>
			  <div class="input_radio <?php if ($this->_vars['jobs']['sex'] == '300'): ?>select<?php endif; ?>" id="2">女</div>			  
			  <div class="clear"></div>
			  </div>		    </td>
		  </tr>
		  <tr>
			  ...
			  <table border="0" cellpadding="0" cellspacing="0" >
                          <tr>
                            <td width="80" style="padding:0px">
                            	<div>
                            	<div class="input_text_50_bg date_input wid54" id="minage_div"><?php if ($this->_vars['jobs']['min_age']):  echo $this->_vars['jobs']['min_age'];  else: ?>请选择<?php endif; ?></div>
...
" />
                            ...
                            <td width="80"  style="padding:0px">
                            	<div>
                            	<div class="input_text_50_bg date_input wid54" id="maxage_div"><?php if ($this->_vars['jobs']['max_age']):  echo $this->_vars['jobs']['max_age'];  else: ?>请选择<?php endif; ?></div>
...
"/></td>
			<td><label><input name="contact_show" type="checkbox" value="1" <?php if ($this->_vars['jobs']['dispaly_name'] == "100"): ?>checked="checked"<?php endif; ?> /> 对外公开联系人</label></td>
		  </tr>
		  </table>
		  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableall">
			  <tr>
...
"/></td>
				<td><label><input name="telephone_show" type="checkbox" value="1" <?php if ($this->_vars['jobs']['dispaly_mobile'] == "100"): ?>checked="checked"<?php endif; ?> /> 对外公开联系电话</label></td>
			  </tr>
		  </table>
		  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableall">
		  <tr>
...
"/>            	</td>
			<td><label><input name="email_show" type="checkbox" value="1" <?php if ($this->_vars['jobs']['dispaly_email'] == "100"): ?>checked="checked"<?php endif; ?> /> 对外公开联系邮箱</label></td>
		  </tr>
	    </table>
	    <script type="text/javascript">
...
" disabled="disabled"/></td>
				<td><label><input name="notify" type="checkbox" value="1" <?php if ($this->_vars['jobs']['push_email'] == '100'): ?>checked="checked"<?php endif; ?>/>接收</label></td>
		  	</tr>
			<tr>
...
" disabled="disabled"/></td>
				<td><label><input name="notify_mobile" type="checkbox" value="1" id="receiveit" <?php if ($this->_vars['jobs']['push_sms'] == '100'): ?>checked="checked"<?php endif; ?> />接收</label></td>
		  	</tr>
...
;
			...
			var type="扣除";
			<?php endif; ?>				
			$("#total").html("修改本条信息总计"+type+"&nbsp;<span style=\"font-size:20px; color: #FF0000\" >"+totals+"</span>&nbsp;<?php echo $this->_vars['QISHI']['points_quantifier'];  echo $this->_vars['QISHI']['points_byname']; ?>
