...
<meta property="qc:admins" content="27325132706127266547" />
	...
	<div class="index-data-wrap">
		...
		<div class="job-build">
			...
			<div class="floor-item">
				<div class="floor-title"><em>1F</em><span><?php echo $this->_run_modifier("QS_jobs,1065", 'qishi_categoryname', 'plugin', 1); ?>
&nbsp;·&nbsp;<?php echo $this->_run_modifier("QS_jobs,1065", 'qishi_categoryname', 'plugin', 1); ?>
</span></div>
				<div class="floor-box clearfix">
					<!-- 分类 -->
					<div class="floor-sort f-left">
						<?php echo tpl_function_qishi_get_classify(array('set' => "列表名:subcate,类型:QS_jobs_floor,显示数目:20,id:1065"), $this);?>
						<?php if (count((array)$this->_vars['subcate'])): foreach ((array)$this->_vars['subcate'] as $this->_vars['list']): ?>
						<a href="<?php echo $this->_run_modifier($this->_run_modifier($this->_run_modifier($this->_run_modifier($this->_run_modifier($this->_run_modifier("QS_jobslist,jobcategory:", 'cat', 'plugin', 1, 1065), 'cat', 'plugin', 1, "."), 'cat', 'plugin', 1, $this->_vars['list']['parentid']), 'cat', 'plugin', 1, "."), 'cat', 'plugin', 1, $this->_vars['list']['id']), 'qishi_url', 'plugin', 1); ?>
" class="f-sort-item f-left" target="_blank"><?php echo $this->_vars['list']['categoryname']; ?>
					...
					<div class="floor-jobs f-left">
						<?php echo tpl_function_qishi_companyjobs_list(array('set' => "列表名:comjobs,显示数目:10,显示职位:3,职位分类:1065"), $this);?>
...
" width="378" height="60" border="0" /></a></div>
			...
			<!-- 楼层 2 -->
			<div class="floor-item">
				<div class="floor-title"><em>2F</em><span><?php echo $this->_run_modifier("QS_jobs,1066", 'qishi_categoryname', 'plugin', 1); ?>
&nbsp;·&nbsp;<?php echo $this->_run_modifier("QS_jobs,1066", 'qishi_categoryname', 'plugin', 1); ?>
&nbsp;·&nbsp;<?php echo $this->_run_modifier("QS_jobs,6", 'qishi_categoryname', 'plugin', 1); ?>
</span></div>
				<div class="floor-box clearfix">
					<!-- 分类 -->
					<div class="floor-sort f-left">
						<?php echo tpl_function_qishi_get_classify(array('set' => "列表名:subcate,类型:QS_jobs_floor,显示数目:20,id:1066"), $this);?>
						<?php if (count((array)$this->_vars['subcate'])): foreach ((array)$this->_vars['subcate'] as $this->_vars['list']): ?>
...
" class="f-sort-item f-left" target="_blank"><?php echo $this->_vars['list']['categoryname']; ?>
					...
					<!-- 职位 -->
					<div class="floor-jobs f-left">
						<?php echo tpl_function_qishi_companyjobs_list(array('set' => "列表名:comjobs,显示数目:10,显示职位:3,职位分类:1066"), $this);?>
						<?php if (count((array)$this->_vars['comjobs'])): foreach ((array)$this->_vars['comjobs'] as $this->_vars['list']): ?>
						<div class="f-job-row">
							<a href="<?php echo $this->_vars['list']['company_url']; ?>
" class="f-job-com underline" target="_blank"><?php echo $this->_vars['list']['companyname']; ?>
