<?php require_once('/Users/Kevin/waibao/codes/yjobs/include/template_lite/plugins/modifier.qishi_url.php'); $this->register_modifier("qishi_url", "tpl_modifier_qishi_url",false);  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2016-09-20 09:56 CST */ ?>
		...
		<div class="meunbox">
		  <div class="tit"><div class="t c2">简历管理</div></div>
		  	<div class="linktxt">
			   ...
			   <?php if ($this->_vars['QISHI']['company_apply']): ?>
				<li><a href="company_recruitment.php?act=fastapply">快速报名</a></li>
				<?php endif; ?>
				</ul>
			</div>
		</div>
		<div class="meunbox">
		  <div class="tit"><div class="t c4">会员服务</div></div>
		  	<div class="linktxt">
				...
				<li <?php if ($_GET['act'] == "order_add" || $_GET['act'] == "setmeal_list" || $_GET['act'] == "order_list" || $_GET['act'] == "payment" || $_GET['act'] == "setmeal_order_add" || $_GET['act'] == "gifts"): ?>class="h"<?php endif; ?>><a href="company_service.php?act=order_add">充值订单</a></li>
				<?php elseif ($this->_vars['QISHI']['operation_mode'] == "2"): ?>
				<li <?php if ($_GET['act'] == "setmeal_list" || $_GET['act'] == "order_list" || $_GET['act'] == "payment" || $_GET['act'] == "setmeal_order_add"): ?>class="h"<?php endif; ?>><a href="company_service.php?act=setmeal_list">充值订单</a></li>
				<?php endif; ?>
