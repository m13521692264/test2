<?php require_once('/Users/Kevin/waibao/codes/yjobs/include/template_lite/plugins/function.qishi_pageinfo.php'); $this->register_function("qishi_pageinfo", "tpl_function_qishi_pageinfo",false);  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2016-09-22 10:20 CST */ ?>
...
user/connect_taobao.php" class="taobao">淘宝</a>
 ...
 网站备案：<?php echo $this->_vars['QISHI']['icp'];  echo $this->_vars['QISHI']['statistics']; ?>
   ...
   Powered by   <a href="http://www.74cms.com/" target="_blank">74cms v<?php echo $this->_vars['QISHI']['version']; ?>
</a>   版权所有 | 仿冒必究</p>
